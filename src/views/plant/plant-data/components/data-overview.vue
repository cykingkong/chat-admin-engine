    ...
    <a-row class="banner" justify="space-between">
      <a-col flex="250px" class="accountCheck">
        <div class="titleBox">
          <div class="textBox">
            ...
            <div class="titleText" style="color: #000"> 数据概览 </div>
          </div>
        </div>
      </a-col>
      ...
      <a-col flex="170px">
        <a-radio-group
          ...
          @change="fetchData()"
        >
          <a-radio :value="1" :disabled="timeDisalbed">时段统计</a-radio>
          <a-radio :value="2">按天统计</a-radio>
        </a-radio-group>
      </a-col>
    </a-row>
    <div style="padding: 0 15px 0 0">
      <Chart style="height: 328px; margin-top: 10px" :option="chartOption" />
    </div>
    <!-- </a-card> -->
  </a-spin>
</template>
...
<script lang="ts" setup>
  ...
  import { reportHourData, reportDayData } from '@/api/plant';
