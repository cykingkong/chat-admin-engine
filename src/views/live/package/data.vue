...
<script lang="ts" setup>
  ...
  import { videoGrid, goodsGrid } from '@/api/plant';
  import {
    taskStatus,
    hotStatus,
    enumToObject,
  ...
  import ExportList from '@/views/plant/plant-data/components/export-list.vue';
    ...
    try {
      ...
      if (data.grid) {
        data.grid.forEach((el: any, key: any) => {
          ...
          //           (el.cost - el.indemnifyVoucherAmount)
          //       );
          ...
          // el.indemnifyVoucherAmountRoi =
          //   el.cost - el.indemnifyVoucherAmount <= 0
          //     ? '-'
          //     : fun2(
          //         el.productPlaceorderGmv /
          //           (el.cost - el.indemnifyVoucherAmount)
